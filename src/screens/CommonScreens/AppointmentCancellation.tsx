...
const AppointmentCancellation = ({route}) => {
  ...
  console.log('PARAMSSS',type,appid);
  ...
  return (
   <Container statusBarStyle='dark-content' >
    ...
    <KeyBoardAvoidWrapper>
      ...
      <PrimaryButton buttonText={strings.iWanttoCancel} onPress={formik.handleSubmit} marginHorizontal={responsiveWidth(3)} />
